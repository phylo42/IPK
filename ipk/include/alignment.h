...
namespace ipk
{
    ...
    alignment i2l(alignment original_alignment, const i2l::phylo_tree& tree);

    class alignment
    {
        friend alignment extend_alignment(alignment original_alignment, const i2l::phylo_tree& tree);
    public:
